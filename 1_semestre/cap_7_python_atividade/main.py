anos_fumando: float = float(input("A quantos anos você fuma? "))
valor_maco: float = float(input("Qual o valor atual do maço de cigarros? R$ "))
macos_por_dia: float = float(input("Quantos maços você fuma por dia, em média? "))

dias_por_ano: float = 365.25
montante_gasto: float = anos_fumando * dias_por_ano * macos_por_dia * valor_maco
